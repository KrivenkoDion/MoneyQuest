...
function Home() {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    btnExpense:    { flex: 1, padding: "14px 0", borderRadius: 14, border: "none", background: "#1a1a2e", color: "white", fontSize: 14, fontWeight: 600, cursor: "pointer" },
    btnIncome:     { flex: 1, padding: "14px 0", borderRadius: 14, border: "2px solid #1a1a2e", background: "transparent", color: "#1a1a2e", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.balanceSection}>
        ...
        <div style={s.actions}>
          <button style={s.btnExpense} onClick={() => { setType("expense"); setBalanceError(""); setShowModal(true); }}>
            + Add Expense
          </button>
          <button style={s.btnIncome} onClick={() => { setType("income"); setBalanceError(""); setShowModal(true); }}>
            + Add Income
          </button>
        </div>
      </div>
